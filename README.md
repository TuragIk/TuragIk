...
*June 2025 – Present*
* Researching marketspaces in cybersecurity software and conducting evaluations on customer behalf to best select a product.
...
* Implemented support for byte, line, word, and character counts using standard flags.
* Optimized for performance using buffered I/O to handle both file paths and standard input (stdin) streams.
...
### UMass URV AI in Cybersecurity Research
- **Description**: Collaborated with two undergraduate students under the supervision of a Ph.D student in the Secure, Private Internet (SPIN) Research Group at UMass Amherst to explore the applications of LLMs and Generative AI in cybersecurity. 
...
- **Description**: Collaborated with a partner to create a survey paper of the threats and defenses of backdoor attacks in the field of machine learning.
...
* **Career Essentials in Cybersecurity by Microsoft and LinkedIn**: Network security fundamentals and threat management.
